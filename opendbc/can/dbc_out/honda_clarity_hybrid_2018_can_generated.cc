...
const Val vals[] = {
    {
      .name = "STEER_STATUS",
      .address = 0x18F,
      .def_val = "5 TMP_FAULT 4 NO_TORQUE_ALERT_2 2 NO_TORQUE_ALERT_1 0 NORMAL",
      .sigs = sigs_399,
    },
    {
      .name = "GEAR_SHIFTER",
...
const DBC honda_clarity_hybrid_2018_can_generated = {
  .name = "honda_clarity_hybrid_2018_can_generated",
...
dbc_init(honda_clarity_hybrid_2018_can_generated)