...
class SelfdriveD:
  ...
  def update_events(self, CS):
    ...
    if os.environ['DONGLE_ID'] != UNREGISTERED_DONGLE_ID and not gps_ok and self.sm['deviceMotion'].inputsOK and (self.distance_traveled > 1500 and self.distance_traveled < 3000):
