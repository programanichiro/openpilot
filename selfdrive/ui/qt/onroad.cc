...
//以下オリジナル表示要素
  ...
  p.drawText(QRect(rect().left()+65+120, rect().top()+110+7, 300, 65), Qt::AlignTop | Qt::AlignLeft, temp_disp3);
  configFont(p, FONT_OPEN_SANS, 54, "Bold");
  p.drawText(QRect(rect().left()+65+55+5, rect().top()+110-8+9, 300, 65), Qt::AlignTop | Qt::AlignLeft, temp_disp2);
