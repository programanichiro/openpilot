...
//  [STATUS_ALERT] = QColor(0xC9, 0x22, 0x31, 0xf1),
    ...
    if(is_cruise_set){
      ...
      drawTextCenter(p, rect().center().x() + w/2 + 43, 290 + y_ofs-35 , QString::number(ACC_speed) , velo_for_trans < velo_for_trans_limit ? 100 : 220 , false , 0x24, 0x57, 0xa1 , 240, 240, 240, velo_for_trans < velo_for_trans_limit ? 70 : 230 , 9 , 15 , 18 , 2);
    }
  }
