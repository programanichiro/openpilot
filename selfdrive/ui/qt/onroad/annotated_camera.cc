...
//以下オリジナル表示要素
  ...
  { //タコメーター
    ...
    QPointF taco_meter[] = {{(double)rect().center().x()-200-80,(double)20},{(double)rect().center().x()-100-60,(double)50 + 40*3+10}, {(double)rect().center().x()+100+60,(double)50 + 40*3+10}, {(double)rect().center().x()+200+80,(double)20}};
    p.setPen(Qt::NoPen);
