...
void AnnotatedCameraWidget::knightScanner(QPainter &p) {
  ...
  {
    p.setPen(Qt::NoPen);
    debug_disp_xpos = drawTextLeft(p , debug_disp_xpos , rect_h - 10 , QString("↓") , 200 , false , 0xdf, 0xdf, 0x00 , 35, 35, 35, 128 , 13 , 5 , 11 , 0 , -5) + 11;
  ...
  }
  {
    ...
    p.setPen(Qt::NoPen);
    debug_disp_xpos = drawTextLeft(p , debug_disp_xpos+4 , rect_h - 10 , QString("AP") , 200 , false , 0xdf, 0xdf, 0x00 , 35, 35, 35, 128 , 13 , 5 , 4 , -1 , -5) + 4;
  ...
  {
    p.setPen(Qt::NoPen);
    debug_disp_xpos = drawTextLeft(p , debug_disp_xpos+6 , rect_h - 10 , QString("Trip") , 200 , false , 0xdf, 0xdf, 0x00 , 35, 35, 35, 128 , 13 , 5 , 10 , -5 , -5) + 5;
