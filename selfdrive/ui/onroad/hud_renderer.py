...
class HudRenderer(Widget):
  ...
  def _ip_draw(self, rect: rl.Rectangle):
    ...
    debug_disp_xpos = self._drawTextLeft(self._font_semi_bold , font_size_debug_info , debug_disp_xpos , rect_h - 10 , ahr_str , 140 , False , 0, 0, 0 , 0xdf, 0xdf, 0x00, 200 , 13 , 5 , 4 , 0 , -5)
