...
class HudRenderer(Widget):
  ...
  def _ip_draw(self, rect: rl.Rectangle):
    ...
    next_x = self._drawTextRight(self._font_uni, 44 , rect.x+rect.width-10, rect.y+rect.height+1 , "テスト神奈川県茅ヶ崎市道路情報(12345)", 220 , bk_alp=128, bk_corner_r= 0.2, bk_yofs=7,bk_add_h=-9,bk_add_w=0)
