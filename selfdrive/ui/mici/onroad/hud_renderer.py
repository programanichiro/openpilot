...
class HudRenderer(Widget):
  ...
  def _ip_draw(self, rect: rl.Rectangle):
    ...
    if gui_app.big_ui():
      ...
      rect_h0 = rect.y+font_size_debug_info-4
      ...
      debug_disp_xpos = self._drawTextRight(self._font_JP , font_size_debug_info , debug_disp_xpos -10 , rect_h0+4 , "↓" , 200 , False , 0xdf, 0xdf, 0x00 , 0, 0, 0, 140 , 5 , 0.3 , bk_add_w=11-4 , bk_xofs=0 , bk_add_h=-5)
      ...
      debug_disp_xpos = self._drawTextRight(self._font_semi_bold , font_size_debug_info , debug_disp_xpos-6-4 , rect_h0+4 , "Trip" , 200 , False , 0xdf, 0xdf, 0x00 , 0, 0, 0, 140 , 5 , 0.3 , 10 , -3 , -5)
