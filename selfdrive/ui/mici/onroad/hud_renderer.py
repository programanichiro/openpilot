...
class HudRenderer(Widget):
  ...
  def _ip_draw(self, rect: rl.Rectangle):
    ...
    #self._font_uni = gui_app.font("JP2", "テスト神奈川県茅ヶ崎市道路情報(12345)")
    self._font_uni = gui_app.font("JP2", "テスト神奈川県茅")
    self._font_uni = gui_app.font("JP2", "川県茅ヶ崎市道路情報(12")
    self._font_uni = gui_app.font("JP2", "ヶ崎市道路(345)")
