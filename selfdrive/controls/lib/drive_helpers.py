...
MAX_CURVATURE_RATES = [0.03762194918267951 * 5, 0.03762194918267951 * 1.2, 0.03762194918267951 * 0.7] #藤沢警察署前Y字路カーブ、キコーナ前上りカーブ、養命寺横カーブ、吹上下り走行車線成功,どこまで上がる？,低速域の限界を上げてみる。
...
def get_lag_adjusted_curvature(CP, v_ego, psis, curvatures, curvature_rates):
  ...
  k_v = 1.0 if vv2 >= 75/3.6 else 1+ (1 - vv2 / (75/3.6))*(2.1-1) # 1〜0 -> 1〜2.1(75km/h以上はk_v=1)
