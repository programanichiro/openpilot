...
#  }
    ...
    #self.v_desired_trajectoryに119とa_desired_mulの制限をかませる。→v_desired_trajectoryが無くなった。
    # if g_tss_type < 2:
    ...
    #self.a_desired_mulの影響を与える場所がなくなる
    ...
    follow_distance_cost_signed = (follow_distance_error / (v_ego + 1))**1 * np.sign(follow_distance_error)
