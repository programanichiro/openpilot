...
class Controls:
  ...
  def state_control(self):
    ...
    try:
      ...
      pass
    CC.latActive = (self.sm['selfdriveState'].active or steer_always != 0) and not CS.steerFaultTemporary \
                    and not CS.steerFaultPermanent and not standstill and True if steer_always == 0 else \
