...
def create_accel_command(packer, accel, accel_raw, pcm_cancel, stopping, standstill_req, lead, acc_type, fcw_alert, true_lead, distance):
  ...
  values = {
    ...
    "ACCEL_CMD_ALT": accel if true_lead else -2.5 if stopping else accel_raw,
  }
