...
class TestMapRenderer:
  ...
  def setup_method(self):
    ...
    self.pm = messaging.PubMaster(['my-LiveLocationKalman'])
  ...
  def _setup_test(self):
    assert self.pm.wait_for_readers_to_update("my-LiveLocationKalman", 10)
  ...
  def _run_test(self, expect_valid, locations=LOCATION1_REPEATED):
    ...
    for i, location in enumerate(locations):
      ...
      self.pm.send("my-LiveLocationKalman", llk)
      self.pm.wait_for_readers_to_update("my-LiveLocationKalman", 10)
